...
const InteractiveCard = ({title,className,id,width,href,src}) => {
    ...
    return (
        <>
           <>
           <General.BgImage className={`inline-block bg-center bg-cover bg-no-repeat bg-gray-300 rounded-3xl text-white ${className}`} src={src}/*{storage.img_sc}*/ width={width}>
